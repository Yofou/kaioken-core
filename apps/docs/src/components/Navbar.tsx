...
export function Navbar() {
  return (
    <nav className="flex justify-between items-center w-full col-span-full gap-4 p-4 bg-[#1e1e1e] border-b border-black/50">
      <a className="flex items-center font-cabin font-semibold text-[1.2rem]" href="/">
        <img className="w-[64px] h-[64px]" src="/kaioken-hook.svg" />
        Kaioken-Core/Hooks
      </a>

      <button className="bg-grey-900 p-2 w-full max-w-[500px] items-center text-left flex justify-between font-cabin border border-white/30 h-max rounded-md">
        Search
